...
<div align="center"> <h1>👋 Sergio Armando Irigoyen Vega </h1> <h3>💻 Systems Engineer · 🛡️ Cybersecurity · 🖥️ IT Infrastructure · 🌐 Web Development</h3> <p> <img src="https://komarev.com/ghpvc/?username=saiv4568&label=Profile%20Views&color=2563eb&style=flat-square" alt="Profile Views"/> <img src="https://img.shields.io/github/followers/saiv4568?label=Followers&style=flat-square&color=2563eb" alt="Followers"/> <img src="https://img.shields.io/github/stars/saiv4568?label=Stars&style=flat-square&color=2563eb" alt="Stars"/> </p> </div> <hr style="border:0;height:1px;background:linear-gradient(90deg,#0e1b2e00,#2563eb,#0e1b2e00);margin:16px 0;"/>
🧠 About Me
Systems Engineer with an interest in IT infrastructure, technical support, cybersecurity, ethical hacking, networking, and web development.

I enjoy solving technical problems, managing systems and infrastructure, developing practical solutions, and continuously learning about new technologies.

My focus is on building and maintaining reliable, secure, and efficient IT environments, combining infrastructure, automation, development, and security.

<hr style="border:0;height:1px;background:linear-gradient(90deg,#0e1b2e00,#2563eb,#0e1b2e00);margin:16px 0;"/>
🛠️ Technologies & Tools
<div align="center"> <h4>⚙️ Core Technologies</h4> <img src="https://skillicons.dev/icons?i=python,php,laravel,linux,windows,docker,bash,git,github,mysql,html,css" alt="Core Technologies"/>
<br/><br/>
...
More projects and technical documentation coming soon.
